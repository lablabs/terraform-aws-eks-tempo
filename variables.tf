...
variable "namespace" {
  type        = string
  default     = "tempo"
  description = "The K8s namespace in which the tempo service account has been created"
}

variable "settings" {
  type        = map(any)
  default     = {}
  description = "Additional helm sets which will be passed to the Helm chart values, see https://hub.helm.sh/charts/stable/tempo"
}

variable "values" {
  type        = string
  default     = ""
  description = "Additional yaml encoded values which will be passed to the Helm chart, see https://hub.helm.sh/charts/stable/tempo"
}
...
variable "service_account_name" {
  type        = string
  default     = "tempo"
  description = "The k8s tempo service account name"
}
...
variable "irsa_role_name_prefix" {
  type        = string
  default     = "tempo-irsa"
  description = "The IRSA role name prefix for tempo"
}
